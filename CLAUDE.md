...
**Current status: Milestones 1 (Foundation + Clipboard), 2 (Snippets), and 3
(Symbols) are complete.** Developer/Keyboard are still wired-in placeholder
tabs — see `docs/SPEC.md`'s milestone checklist for what's next.
